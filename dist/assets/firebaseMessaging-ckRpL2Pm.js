import{r as b,_ as m,C as y,l as O,E as Y,A as D,F as Ie,B as S,d as P,n as ke,D as Se,G as Ae,H as Ee}from"./firebaseFirestore-Dp8TBSU9.js";const z="@firebase/installations",M="0.6.19";/**
 * @license
 ...
 */const X=1e4,Q=`w:${M}`,Z="FIS_v2",ve="https://firebaseinstallations.googleapis.com/v1",_e=3600*1e3,Ce="installations",Ne="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ft="/firebase-messaging-sw.js",pt="/firebase-cloud-messaging-push-scope",ge="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",lt="https://fcmregistrations.googleapis.com/v1",we="google.c.a.c_id",gt="google.c.a.c_l",wt="google.c.a.ts",ht="google.c.a.e",B=1e4;var V;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(V||(V={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ye(e,t){if(!navigator)throw u.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw u.create("permission-blocked");return await Bt(e,t?.vapidKey),await xt(e,t?.serviceWorkerRegistration),Nt(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wt(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===w.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(U(n)):e.onMessageHandler.next(U(n)));const o=n.data;Kt(o)&&o[ht]==="1"&&await Vt(e,n.messageType,o)}const G="@firebase/messaging",J="0.12.23";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qt(e=ke()){return Yt().then(t=>{if(!t)throw u.create("unsupported-browser")},t=>{throw u.create("indexed-db-unsupported")}),O(P(e),"messaging").getImmediate()}async function Zt(e,t){return e=P(e),ye(e,t)}function en(e,t){return e=P(e),zt(e,t)}Jt();export{Zt as a,Qt as g,en as o};
